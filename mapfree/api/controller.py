...
class MapFreeController:
    ...
    def run_project(self, image_path, project_path, on_event=None, chunk_size=None, force_profile=None, event_emitter=None):
        ...
        pipeline = Pipeline(engine, ctx, on_event, chunk_size=chunk_size, force_profile=force_profile, event_emitter=event_emitter)
        pipeline.run()
